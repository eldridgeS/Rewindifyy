"""
Django settings for Rewindify project.
...
SECRET_KEY = 'django-insecure-@me7l1h&b!l8ci6bxvkk5mez%&6@=^y22_ykjt(c_fi$v%i%oj'
...
WSGI_APPLICATION = 'Rewindify.wsgi.application'
...
STATICFILES_DIRS = [os.path.join(BASE_DIR, 'myappp/static')]
